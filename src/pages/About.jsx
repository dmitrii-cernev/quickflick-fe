        ...
        <div className={"main-gradient py-2 sm:p-8"}>
            <div
                ...
                <div className="m-1 sm:m-6 p-2 sm:p-6 rounded-md shadow-md">
                    ...
                    <p className="text-lg mb-4">
                        Our platform is designed to help you easily summarize and transcribe
                        short-form
                        videos from popular social media platforms like TikTok, Instagram, and
                        YouTube
                        Shorts.
                    </p>
                    ...
                    <ul className="list-disc pl-6 mb-4">
                        <li className="mb-2">Save Useful Videos: Our primary goal is to empower
                            users to
                            save and store valuable content from social media.
                        </li>
                        <li className="mb-2">Efficient Summarization: We aim to provide an efficient
                            way
                ...
                <p className="text-xl">
                    Join us on this journey of simplifying and enhancing the way you interact with
                    short
