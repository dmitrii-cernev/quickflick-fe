...
const RegistrationPage = () => {
    ...
    return (
        <div className={"main-gradient p-8"}>
            <div
                className="flex justify-center items-center h-screen sm:bg-gray-100 sm:bg-opacity-40 w-11/12 mx-auto rounded-xl animate-fade animate-duration-200">
                <div
                    className="w-10/12 sm:w-6/12 bg-white p-6 sm:px-12 rounded-lg shadow-md bg-opacity-40">
